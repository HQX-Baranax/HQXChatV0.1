...
namespace HQXChatUygulamasi
{
    public partial class Giris : Form
    {
        ...
        {
            InitializeComponent();
            //con = new MySqlConnection("Server=localhost;Database=dbLogin;user=root;Pwd=baran2104;SslMode=none");
        }
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Lütfen Kullancı Adı Giriniz!", "HATA", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            else
            {
